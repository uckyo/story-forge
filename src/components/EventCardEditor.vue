  ...
  >
    <el-form label-width="80px">
      <el-form-item label="名称" required>
        <el-input v-model="formData.name" placeholder="请输入事件名称"></el-input>
      </el-form-item>
      ...
      <el-form-item label="时间">
        <el-input v-model="formData.time" placeholder="事件发生的时间"></el-input>
      </el-form-item>
      
      <el-form-item label="地点">
        <el-input v-model="formData.location" placeholder="事件发生的地点"></el-input>
      </el-form-item>
      
      <el-form-item label="参与角色">
        <el-input v-model="formData.participants" placeholder="参与的主要角色（逗号分隔）"></el-input>
      </el-form-item>
