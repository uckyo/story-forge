  ...
  >
    <el-form label-width="80px">
      <el-form-item label="名称" required>
        <el-input v-model="formData.name" placeholder="请输入物品名称"></el-input>
      </el-form-item>
      ...
      <el-form-item label="类型">
        <el-input v-model="formData.itemType" placeholder="例如：武器、工具、饰品、药品、魔法物品等"></el-input>
      </el-form-item>
      
      <el-form-item label="所有者">
        <el-input v-model="formData.owner" placeholder="物品的当前所有者"></el-input>
      </el-form-item>
      
      <el-form-item label="价值">
        <el-input v-model="formData.value" placeholder="物品的价值或重要性"></el-input>
      </el-form-item>
