  ...
  >
    <el-form label-width="80px">
      <el-form-item label="名称" required>
        <el-input v-model="formData.name" placeholder="请输入设定名称"></el-input>
      </el-form-item>
      <el-form-item label="简述">
        <el-input v-model="formData.brief" type="textarea" placeholder="简要描述"></el-input>
      </el-form-item>
      <el-form-item label="类别">
        <el-input v-model="formData.category" placeholder="设定类别，如：魔法、科技、历史、政治等"></el-input>
      </el-form-item>
      <el-form-item label="影响范围">
        <el-input v-model="formData.influence" placeholder="该设定影响的范围"></el-input>
      </el-form-item>
