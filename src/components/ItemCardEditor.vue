<template>
  <el-dialog
    ...
    :title="props.card && props.card.id ? '编辑物品卡片' : '新增物品卡片'"
    width="600px"
    @close="handleClose"
  >
    <el-form label-width="80px">
      ...
      <el-form-item label="类型">
        <el-input
          ...
          placeholder="例如：武器、工具、饰品、药品、魔法物品等"
        ></el-input>
      </el-form-item>
  ...
  (newCard) => {
    if (newCard) {
      Object.assign(formData, {
        id: newCard.id,
        name: newCard.name || "",
        type: newCard.type || "item",
        brief: newCard.brief || "",
        content: newCard.content || "",
        tags: [...(newCard.tags || [])],
        color: newCard.color || "",
        // 物品特有字段
        itemType: newCard.itemType || "",
        owner: newCard.owner || "",
        value: newCard.value || "",
      });
    } else {
